...
```
Hiervan is ook een [downloadbare versie](https://raw.githubusercontent.com/VNG-Realisatie/ddas/refs/heads/Vroegsignalering/vroegsignalering/docs/koppelvlakspecificatie/v0.1/DDAS-SHV_v0.1.1.yaml) van.
...
```
Hiervan is ook een [downloadbare versie](https://raw.githubusercontent.com/VNG-Realisatie/ddas/refs/heads/Vroegsignalering/vroegsignalering/docs/koppelvlakspecificatie/v0.1/DDAS-VS_v0.1.1.yaml) van.
