...
Er is verder gekozen voor het *JAdES-B* profiel van ondertekenen. Dat wil zeggen dat naast de ondertekening enkel het gebruikte certificaat, de verwijzing naar het certificaat en het tijdstip van ondertekenen geregistreerd worden. Zwaardere profielen, waarbij ook een trusted timestamp en verificatie informatie geregistreerd wordt, zijn voor DDAS niet nodig.
